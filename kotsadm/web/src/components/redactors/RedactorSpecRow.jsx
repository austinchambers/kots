    ...
    return (
      <div className="flex flex-auto ActiveDownstreamVersionRow--wrapper" key={redactor.name}>
        ...
        <div className="flex alignItems--center">
          <Link to={`/redactor/specs/${redactor.id}`} className="u-fontSize--normal u-fontWeight--medium u-color--royalBlue u-textDecoration--underlineOnHover u-marginRight--20">Edit redactor</Link>

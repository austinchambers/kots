...
func NewBuilder(configGroups []kotsv1beta1.ConfigGroup, existingValues map[string]ItemValue, localRegistry LocalRegistry, cipher *crypto.AESCipher, license *kotsv1beta1.License, privateLicense *kotsv1beta1.PrivateLicense) (Builder, map[string]ItemValue, error) {
	b := Builder{}
	configCtx, err := b.newConfigContext(configGroups, existingValues, localRegistry, cipher, license, privateLicense)
	if err != nil {
